...
<div id="menu">
	<a href="${base}/pet/all">${msg.pets_title }</a>
	&gt; <b>${obj.name}</b>
</div>
<!--
====================================================================== 
-->
<form id="photo" action="${base}/pet/uploadphoto" method="POST"
...
====================================================================== 
-->
<form action="${base}/pet/update"  name="pet" method="POST" class="detail">
<input type="hidden" name="id" value="${obj.id}"/>
