...
<div id="menu">
	...
	<form id="new_pet" action="${base}/pet/add" method="POST" style="display: none">
...
<c:forEach var="pet" items="${obj}">
	<tr>
		<td><li>&nbsp;</li></td>
		<td><a href="${base}/pet/detail?id=${pet.id}">${pet.name}</a></td>
		<td><i>(${pet.age} ${msg.age} / ${pet.color} / ${pet.race})</i></td>
		<td>&nbsp;</td>
		<td> &gt;<a href="${base}/pet/remove?id=${pet.id}">${msg.remove}</a></td>
	</tr>
</c:forEach>
</table>
